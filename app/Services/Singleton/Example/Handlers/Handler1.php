...
class Handler1 implements SingletonExampleInterface
{
...
//    }
    ...
    {
        echo 'Echo form h1' . PHP_EOL;
//        echo $this->saveDataStorage->getCount() . PHP_EOL;
//        $this->saveDataStorage->setCount(5) . PHP_EOL;
//        echo $this->saveDataStorage->getCount() . PHP_EOL;

        echo SaveDataStorage::getInstance()->getCount() . PHP_EOL;
        SaveDataStorage::getInstance()->setCount(5);
        echo SaveDataStorage::getInstance()->getCount() . PHP_EOL;
        return $next($DTO);
    }
}
